...
git remote add origin git@github.com:username/testmulti.git
...
git add .
git commit -am "first commit"
git remote add origin git@bitbucket.org:username/testbucket.git
git push origin master
```  
...
```shell
git clone git@bitbucket.org:bitbucket_username/booker.git
...
[Source](https://gist.github.com/rosswd/e1afd2b0b0d515517eac)
